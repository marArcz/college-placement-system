            ...
            <div class="col-md-6 left-side">
                <a href="index.php" class="link-dark text-decoration-none">
                    <div class="text-center">
                        ...
                        <div class="mt-4">
                            <p class="fw-bold fs-6 text-blue">ADMIN PANEL</p>
                        </div>
                    </div>
                </a>
            </div>
            <div class="col-md-6 right-side admin">
                <div class="col-md-8 mx-auto">
                    <div class="d-flex align-items-center justify-content-center text-center text-white mb-4 fw-bold">
                        ...
                        <h1 class="ms-2 my-0">ADMIN LOG IN</h1>
                    </div>
                    ...
                    <div class="mt-4 text-center text-white">
                        <a href="signup.php" class="link-light">Forgot password?</a>
                    </div>
                </div>
            </div>
        </div>
