class Calendar {
    constructor({ element, events = [], activeColor = "rgb(74 161 233)" }) {
    ...
    displayDays(currentDays) {
        ...
        for (let day of currentDays) {
            if (day.passed) {
                ...
                let calendarDay = `
                        <div data-date="${day.year}-${day.month + 1}-${day.number}" class="enabled calendar-day ${day.currentMonth ? "current-day" : ""} ${day.isSelected ? "selected" : ""}">
