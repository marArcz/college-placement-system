...
<?php include '../app/edit-work-experience.php' ?>
<?php
if (!isset($_GET['id'])) {
...
$query = $pdo->prepare("SELECT * FROM experiences WHERE id =?");
$query->execute([$work_experience_id]);

$work_experience = $query->fetch();
...
<body>
    ...
    <div class="container mt-3 mb-3">
        ...
        <div class="col-md-8 mx-auto">
            ...
            <p class="fs-4 fw-semibold mt-2 mb-3">Edit work experience</p>
            <form action="" method="post">
                <div class="mt-3 mb-3">
                    <label for="" class="form-label">Job title <span class="text-danger fs-4">*</span></label>
                    <input type="text" class="form-control" value="<?= $work_experience['job_title'] ?>" name="job_title" required>
                </div>
                <div class=" mb-3">
                    <label for="" class="form-label">Company</label>
                    <input type="text" class="form-control" value="<?= $work_experience['company'] ?>" name="company" required>
                </div>
                <p class="fw-semibold">Time period</p>
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" <?= $work_experience['is_current_job'] ? 'checked' : '' ?> name="current_job" value="true" id="current-job">
                    ...
                    <div class="row gy-3">
                        <div class="col-md">
                            <select name="month_from" class="form-select" required>
                                ...
                                ?>
                                    <option <?= $work_experience['month_from'] == $month ? 'selected' : '' ?> value="<?= $month ?>"><?= $month ?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="col-md">
                            <select name="year_from" class="form-select" required>
                                ...
                                ?>
                                    <option <?= $work_experience['year_from'] == $year ? 'selected' : '' ?> value="<?= $year ?>"><?= $year ?></option>
                                <?php
                                }
                                ?>
                            </select>
                    ...
                    <div class="row gy-3" id="time-to">
                        <div class="col-md">
                            <select name="month_to" class="form-select">
                                ...
                                foreach ($months as $month) {
                                ?>
                                    <option <?= $work_experience['month_to'] == $month ? 'selected' : '' ?> value="<?= $month ?>"><?= $month ?></option>
                                <?php
                                }
                                ?>
                            </select>
                        ...
                        <div class="col-md">
                            <select name="year_to" class="form-select">
                                ...
                                for ($year = $start_year; $year <= $end_year; $year++) {
                                ?>
                                    <option <?= $work_experience['year_to'] == $year ? 'selected' : '' ?> value="<?= $year ?>"><?= $year ?></option>
                                <?php
                                }
                                ?>
                            </select>
