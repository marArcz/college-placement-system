...
<?php include '../app/add-education.php' ?>
<?php
if (!isset($_GET['id'])) {
...
<body>
    ...
    <div class="container mt-3 mb-3">
        ...
        <div class="col-md-8 mx-auto">
            ...
            <p class="fs-4 fw-semibold mt-2 mb-3">Add education</p>
            <form action="" method="post">
                ...
                <div class="mb-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="currently_enrolled" value="true" id="current-job">
